...
import { crearContacto } from '@/app/actions/contactos'
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mb-5 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
        <strong>Contacto de venta / suministro</strong> — Solo datos de registro, sin acceso al portal.
        Si necesitas un cliente que pueda ingresar al sistema,{' '}
        <Link href="/admin/clientes/nuevo" className="underline font-medium">crea un cliente con acceso</Link>.
      </div>

      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <form action={crearContacto} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Información adicional, historial de compras, preferencias..."
            />
          </div>
